 ...
 * Versão: 2.0 CORRIGIDA - Sintaxe e rotas /desktop/ corrigidas
 * Autor: Manus AI
 */
...
(function() {
    ...
    function getMobilePath(currentPath) {
        ...
        // CORREÇÃO: Mapeamento atualizado para estrutura /desktop/
        const pathMappings = {
            '/': 'mobile/index.html',
            '/index.html': 'mobile/index.html',
            '/desktop/index.html': 'mobile/index.html',
            '/desktop/pages/quem-somos.html': 'mobile/sobre-nos.html',
            '/desktop/pages/cursos.html': 'mobile/cursos.html',
            '/desktop/pages/biblioteca-cursos.html': 'mobile/cursos.html',
            '/desktop/pages/seja-instrutor-novo.html': 'mobile/seja-instrutor.html',
            '/desktop/pages/contato.html': 'mobile/contato.html',
            '/desktop/pages/login-aluno.html': 'mobile/login.html',
            '/desktop/pages/login-instrutor.html': 'mobile/login.html',
            '/desktop/pages/login-admin.html': 'mobile/login.html',
            '/desktop/pages/dashboard-aluno.html': 'mobile/dashboard-aluno.html',
            '/desktop/pages/dashboard-instrutor.html': 'mobile/dashboard-instrutor.html',
            '/desktop/pages/dashboard-admin.html': 'mobile/dashboard-admin.html',
            '/desktop/pages/forum.html': 'mobile/forum.html',
            '/desktop/pages/gamificacao.html': 'mobile/gamificacao.html',
    ...
    function addDesktopLink() {
        ...
        desktopLink.href = '/desktop/index.html?desktop=1';
        ...
        // CORREÇÃO: Sintaxe corrigida - parênteses em vez de ponto e vírgula
    ...
    function init() {
        debugLog('Initializing mobile detection v2.0...');
        ...
        debugLog('Mobile detection v2.0 initialized');
    }
